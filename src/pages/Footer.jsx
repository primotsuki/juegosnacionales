        ...
        <footer className="w-screen md:h-[50vh] bg-obs text-white grid grid-cols-3 gap-4">
            <div id='ubicaciones' className="col-span-full md:col-span-1 flex flex-col items-center justify-center p-4">
                ...
                {ubicaciones.map(location=>
                    <li className="py-2 font-raleway">
                        <a href={location.location} target="_blank"><i class="fa-solid fa-location-dot text-rose"></i>&nbsp;&nbsp; {location.name} </a>
                    </li>
                    )}
                </ul>
            ...
            <div id='contactos' className='col-span-full md:col-span-1 flex flex-col items-center justify-center'>
                ...
                <div className="flex flex-col items-center py-5">
                    ...
                    <p className="text-3xl"><i class="fa-solid fa-mobile-screen-button"></i> + 591 76140304</p>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <p className="text-3xl"><i class="fa-solid fa-mobile-screen-button"></i> + 591 68069754</p>
                    <a className="p-3 border border-solid rounded-md" target='_blank'
